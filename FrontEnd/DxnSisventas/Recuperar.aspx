                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" onclick="togglePasswordVisibility('<%= txtNewPassword.ClientID %>', 'toggleNewPassword')">Mostrar</button>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" onclick="togglePasswordVisibility('<%= txtConfirmPassword.ClientID %>', 'toggleConfirmPassword')">Mostrar</button>
                                </div>
                            </div>
                        </div>
